...
from ..utils.shortcut_utils import (get_spacing_between_buttons, get_max_shortcut_per_row,
...
class SingleShortcutGridWidget(QWidget):
    ...
    def apply_button_styling(self, button, config, default_config):
        ...
        is_custom = (
            font_color != default_config['font_color'] or
            bg_color != default_config['background_color'] or
            f"{str(font_size)}px" != default_config['font_size']
        )
    ...
    def handle_action_drop(self, event, text):
        ...
        if source_action and source_grid:
            ...
            if self.grid_info == source_grid:
                ...
                self.handle_cross_grid_move(source_action, source_grid, source_index, 
                                          target_index, config_to_move)
    ...
    def handle_cross_grid_move(self, source_action, source_grid, source_index, 
                              target_index, config):
