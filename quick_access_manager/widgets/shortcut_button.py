...
class ShortcutDraggableButton(QPushButton):
    ...
    def apply_color_settings(self):
        ...
        bg_color = self.config.get("backgroundColor", default_config['background_color'])
        
        # Check if using custom colors
        is_custom = (
            font_color != default_config['font_color'] or
            bg_color != default_config['background_color']
        )
    ...
    def setup_connections(self):
        ...
        self.clicked.connect(lambda: self.parent_section.run_krita_action(self.action.objectName()))
