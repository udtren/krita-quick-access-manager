...
def _get_krita_data_dir():
    ...
    Computed by navigating up from pykrita/quick_access_manager/legacy/utils/.
    """
    # __file__ => krita/pykrita/quick_access_manager/legacy/utils/config_utils.py
    utils_dir = os.path.dirname(os.path.abspath(__file__))
    legacy_dir = os.path.dirname(utils_dir)           # .../quick_access_manager/legacy/
    plugin_dir = os.path.dirname(legacy_dir)          # .../quick_access_manager/
...
def get_plugin_dir():
    """Get the legacy implementation source directory inside pykrita.

    Returns path like: AppData/Roaming/krita/pykrita/quick_access_manager/legacy
    """
    utils_dir = os.path.dirname(os.path.abspath(__file__))
