from ...compat import QHBoxLayout, QMdiArea, Qt, QWidget
...
class FloatRotation:
    ...
    def __init__(self, window, rotation_widget, rotation_label):
        ...
        # The pad doesn't own a real QDockWidget here (nothing to borrowDocker()),
        # so the container is added to its layout directly - see ntWidgetPad.widget.
