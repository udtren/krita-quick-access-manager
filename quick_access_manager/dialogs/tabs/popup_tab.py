from ...compat import (
    ...
    QScrollArea, QKeySequenceEdit, QComboBox, Qt,
)
...
class PopupTab:
    ...
    def _load(self):
        ...
        _shortcut_row("Actions Popup Shortcut", "actions_popup_shortcut",
                      self.popup_loader.get_actions_popup_shortcut_string)
        _shortcut_row("Brush Sets Popup Shortcut", "brush_sets_popup_shortcut",
                      self.popup_loader.get_brush_sets_popup_shortcut_string)
        _shortcut_row("Color Selector Popup Shortcut", "color_selector_popup_shortcut",
                      self.popup_loader.get_color_selector_popup_shortcut_string)
        _shortcut_row("Preset Switch Popup Shortcut", "preset_switch_popup_shortcut",
        ...
        _int_row("Brush Icon Size", "brush_icon_size", self.popup_loader.get_brush_icon_size)
        _int_row("Grid Label Width", "grid_label_width", self.popup_loader.get_grid_label_width)
