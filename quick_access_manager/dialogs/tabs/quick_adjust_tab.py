...
class QuickAdjustTab:
    ...
    def _load(self):
        ...
        hl = QHBoxLayout()
        label = QLabel("  Toggle Key (e.g. Alt, A, F1, Alt+1, Ctrl+F2 — empty to disable)")
        label.setAlignment(Qt.AlignLeft)
        ...
        hl = QHBoxLayout()
        label = QLabel("  Toggle Key (e.g. Shift, A, F2, Alt+2, Ctrl+F3 — empty to disable)")
        label.setAlignment(Qt.AlignLeft)
        ...
        hl = QHBoxLayout()
        label = QLabel("  Toggle Key (e.g. Shift, A, F3, Alt+3, Ctrl+F4 — empty to disable)")
        label.setAlignment(Qt.AlignLeft)
